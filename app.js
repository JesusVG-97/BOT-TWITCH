...
const config = {
        options: {
          debug: true, // Puedes poner false para desactivar los mensajes de depuración
        },
        connection: {
          reconnect: true, // Conecta automáticamente si se pierde la conexión
...
function tienePermisos(tags) {
  ...
  return rolesPermitidos.some((rol) => tags['user-type'] === rol || usuario === 'voidvic_','valhallahound29');
}