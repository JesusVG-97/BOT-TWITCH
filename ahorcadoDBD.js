...
const palabras = [
    { palabra: 'trapper', descripcion: 'Especializado en colocar trampas para capturar a los supervivientes.' },
    { palabra: 'wraith', descripcion: 'Puede volverse invisible y acechar a los supervivientes.' },
    { palabra: 'hillbilly', descripcion: 'Equipado con una motosierra, es rápido y puede atravesar el mapa rápidamente.' },
    { palabra: 'nurse', descripcion: 'Puede teletransportarse a través del mapa, sorprendiendo a los supervivientes.' },
    { palabra: 'hag', descripcion: 'Crea ilusiones y puede teletransportarse a ellas para emboscar a los supervivientes.' },
    { palabra: 'doctor', descripcion: 'Utiliza electroshocks para desorientar a los supervivientes y hacerlos revelar su posición.' },
    { palabra: 'michael', descripcion: 'Puede volverse completamente invisible y tiene diferentes niveles de poder con su habilidad "Evil Within".' },
    { palabra: 'huntress', descripcion: 'Usa hachas para cazar a los supervivientes desde la distancia.' },
    { palabra: 'cannibal', descripcion: 'Puede usar su motosierra para atacar a varios supervivientes a la vez.' },
    { palabra: 'meg', descripcion: 'Ágil y rápida, capaz de moverse con sigilo y rapidez.' },
    { palabra: 'claudette', descripcion: 'Experta en curación y ocultación, puede sanar a otros y a sí misma de manera efectiva.' },
    { palabra: 'jake', descripcion: 'Habilidoso en sabotear ganchos y en la supervivencia en el bosque.' },
    { palabra: 'nea', descripcion: 'Graffitera urbana, es experta en moverse rápidamente y en la evasión.' },
    { palabra: 'laurie', descripcion: 'Inspirada en el personaje de la película "Halloween", es buena en la evasión y en la lucha por la supervivencia.' },
    { palabra: 'ace', descripcion: 'Hábil en encontrar y utilizar objetos de rareza, así como en la evasión.' },
    { palabra: 'feng', descripcion: 'Jugadora profesional de videojuegos, es rápida y tiene buena resistencia.' },
    { palabra: 'david', descripcion: 'Fuerte y resistente, experto en enfrentamientos directos con el asesino.' },
    { palabra: 'quentin', descripcion: 'Inspirado en el personaje de la película "Pesadilla en Elm Street", es experto en lidiar con situaciones de pesadilla y en ayudar a otros supervivientes.' }
];
...
if (command === '!start') { 
    ...
    // Envía un mensaje al chat con la palabra oculta
